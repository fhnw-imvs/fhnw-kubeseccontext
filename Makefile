...
.PHONY: build
build: manifests generate helm-copy-crds fmt vet ## Build manager binary.
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name orakel-of-funk-builder
	$(CONTAINER_TOOL) buildx use orakel-of-funk-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm orakel-of-funk-builder
	rm Dockerfile.cross
...
deploy-kind: install ## Build a new image, load it into the kind cluster and restart the pod.
	...
	$(KUBECTL) -n orakel-of-funk-system delete pod -l app.kubernetes.io/name=orakel-of-funk
